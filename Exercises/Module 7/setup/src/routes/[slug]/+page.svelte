...
<article>
	<header class={theme ? themes[theme] : null}>
		<h1>{title}</h1>
	</header>
...
<style>
	...
	.svelte {
		background-image: linear-gradient(rgba(102, 51, 153, 0.2), rgba(102, 51, 153, 0.2)),
	...
	.javascript {
		background-image: linear-gradient(rgba(255, 255, 0, 0.5), rgba(255, 255, 0, 0.4)),
